...
import {
  ...
  saveUser,
  selectIsLoggedIn,
  selectIsLoggedInError,
  selectIsLoggedInPending,
  selectUser,
...
const Login = () => {
  ...
  const isLoginError = useSelector(selectIsLoggedInError);
  const isLoginPending = useSelector(selectIsLoggedInPending);
